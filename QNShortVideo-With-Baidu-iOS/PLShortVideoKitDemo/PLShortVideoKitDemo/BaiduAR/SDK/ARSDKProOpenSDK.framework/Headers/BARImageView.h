...
@property(nonatomic, strong) NSSet<UITouch *> *beganTouches;
@property(nonatomic, strong) NSSet<UITouch *> *movedTouches;
@property(nonatomic, strong) NSSet<UITouch *> *endedTouches;
@property(nonatomic, strong) NSSet<UITouch *> *cancelledTouches;
@property(nonatomic, assign) CGFloat barImageViewScale;
/** Handling fill mode
