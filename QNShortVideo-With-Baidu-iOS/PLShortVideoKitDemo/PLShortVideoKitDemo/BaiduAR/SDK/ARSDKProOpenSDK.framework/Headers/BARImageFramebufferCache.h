...
- (BARImageFramebuffer *)fetchFramebufferForSize:(CGSize)framebufferSize textureOptions:(BARTextureOptions)textureOptions onlyTexture:(BOOL)onlyTexture usingTextureCache:(BOOL)usingTextureCache;
