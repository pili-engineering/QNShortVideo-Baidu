...
- (void)pressRecordButtonEvent:(id)sender {
    ...
    recordViewController.plistPath = [[NSBundle mainBundle] pathForResource:@"face_decals" ofType:@"plist"];
    recordViewController.disableDebugInfo = YES;
//    recordViewController.faceAlgoModelDic = self.faceAlgoModelDic;
    recordViewController.cameraToAR = YES;
